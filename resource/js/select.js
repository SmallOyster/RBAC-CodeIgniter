		...
		t = {
			initialize: function(e) {
				...
				for (var o = 0; o < e.data.length; o++) {
					...
					l += "</span>";
					for (var a = 0; a < e.data[o].list.length; a++) 1 == e.data[o].list[a].selected ? (n.push(e.data[o].list[a].optionName), l += '<span class="normal ofen-normal"><input type="checkbox" checked optionId=' + e.data[o].list[a].optionId + ">" + e.data[o].list[a].optionName + "</span>") : l += '<span class="normal ofen-normal"><input type="checkbox" optionId=' + e.data[o].list[a].optionId + ">" + e.data[o].list[a].optionName + "</span>"
				}
			$("#" + e.el).append(l),
